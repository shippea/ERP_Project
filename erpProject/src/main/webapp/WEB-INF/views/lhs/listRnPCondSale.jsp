	 ...
	 $("#buyProBtn1").click(function () {
	        ...
	        $.ajax({
	             ...
	             success: function (data) {
	            	 ...
	            	 if (data === 0) {
	            		 alert("수불마감 처리되었습니다.")
	            		 window.location.href = "lhsListRnPCondSale?empNo=" + empNo 
																+ "&rnpc_year_month_day=" + selectedDate; 
	            	 }
	            	 else if (data === 1) {
	            		 alert("이미 마감상태입니다.")
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center">
					...
					<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
						<li class="page-item"><a class="page-link" href="lhsListRnPCondSale?currentPage=${i}&empNo=${empData.empNo}&gubun=${param.gubun }
