    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="cust_no" readonly >
            </div>
            <div class="form-group">
                <label for="cust_bcomm">거래처 대분류</label> 
                <input type="text" class="form-control" id="cust_bcomm" readonly >
            </div>
    
    		 <div class="form-group">
                <label for="cust_boss">거래처 사장</label> 
                <input type="email" class="form-control" id="cust_boss" readonly>
            </div>
    
             <div class="form-group">
                <label for="cust_tel">거래처 연락처</label> 
                <input type="email" class="form-control" id="cust_tel" readonly>
            </div>
            
               <div class="form-group">
                <label for="cust_b_num">거래처 사업자번호</label> 
                <input type="email" class="form-control" id="cust_b_num" readonly>
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="cust_name" readonly>
            </div>
            <div class="form-group">
                <label for="cust_scomm">거래처 중분류</label> 
                <input type="email" class="form-control" id="cust_scomm" readonly>
            </div>
            <div class="form-group">
                <label for="cust_type">거래처 타입</label> 
                <input type="email" class="form-control" id="cust_type" readonly>
            </div>
            <div class="form-group">
                <label for="cust_email">거래처 이메일</label> 
                <input type="email" class="form-control" id="cust_email" readonly>
            </div>
